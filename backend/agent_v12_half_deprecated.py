...
def generate_recipe(diet, cuisine, specific_ingredients, available_ingredients):
    return user_prompt.format(
        specific_ingredients=', '.join(specific_ingredients),  # Ensure it's a comma-separated string
        available_ingredients=', '.join(available_ingredients),  # Ensure it's a comma-separated string
        diet=diet,
        cuisine=cuisine
    )
