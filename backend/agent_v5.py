...
async def main():
    ...
    while True:
        ...
        prompt = f'Generate a recipe with the following specific ingredients: {", ".join(deps.specific_ingredients)} and preferences: {deps.user_inputs}. Ensure that all user-provided ingredients are included.'
