...
recipe_agent = Agent[Deps, Union[RecipeDetails, NoRecipeFound]](
    ...
    system_prompt=(
        ...
        "3. Always include the ingredients provided by the user."
...
def generate_recipe(diet, cuisine, specific_ingredients, available_ingredients):
    ...
    **Guidelines:**
    1. Do **not** include any extra ingredients unless absolutely necessary. If you must include additional ingredients, list them separately and explain why they were required.
    2. If additional ingredients are not needed, innovate using the available ingredients to create a unique recipe.
    3. Format the steps as follows:
    ...
    4. Keep the recipe simple, clear, and easy to follow while respecting the user preferences (e.g., vegetarian, no eggs, etc.).
    ...
    **Cuisine**: {cuisine}
    ...
    Please make sure the recipe is creative, respects the given preferences, and uses the provided ingredients in an innovative way. Also list your thought process while going through
    '''
    return prompt
