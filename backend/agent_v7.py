#Best perfoming till now with minimum failure
...
async def main():
    ...
    while True:
        ...
        prompt = f'Generate a recipe with the following specific ingredients: {", ".join(deps.specific_ingredients)} and preferences: {deps.user_inputs}. Ensure that all user-provided ingredients are included. Only add additional ingredients if absolutely necessary and list any new ingredients that are not in the provided list.'
